...
lock tables cidade write, cozinha write, estado write, forma_pagamento write,
	...
	oauth_code write, oauth2_authorization write, oauth2_authorization_consent write;
...
(1, 'João da Silva', 'joao.ger@algafood.com', '$2a$12$ug89EzzWyLbScRRU.nsMX.Zw8a52blMihA5b2J7N4n7wM/vM7LtSi', utc_timestamp),
(2, 'Maria Joaquina', 'maria.vnd@algafood.com', '$2a$12$ug89EzzWyLbScRRU.nsMX.Zw8a52blMihA5b2J7N4n7wM/vM7LtSi', utc_timestamp),
(3, 'José Souza', 'jose.aux@algafood.com', '$2a$12$ug89EzzWyLbScRRU.nsMX.Zw8a52blMihA5b2J7N4n7wM/vM7LtSi', utc_timestamp),
(4, 'Sebastião Martins', 'sebastiao.cad@algafood.com', '$2a$12$ug89EzzWyLbScRRU.nsMX.Zw8a52blMihA5b2J7N4n7wM/vM7LtSi', utc_timestamp),
(5, 'Manoel Lima', 'manoel.loja@gmail.com', '$2a$12$ug89EzzWyLbScRRU.nsMX.Zw8a52blMihA5b2J7N4n7wM/vM7LtSi', utc_timestamp),
(6, 'Débora Mendonça', 'phm.paulomorais@gmail.com', '$2a$12$ug89EzzWyLbScRRU.nsMX.Zw8a52blMihA5b2J7N4n7wM/vM7LtSi', utc_timestamp),
(7, 'Carlos Lima', 'phm.paulomorais+carlos@gmail.com', '$2a$12$ug89EzzWyLbScRRU.nsMX.Zw8a52blMihA5b2J7N4n7wM/vM7LtSi', utc_timestamp); 
...
# Exemplo de como eram realizadas as inserções utilizando o spring security antigo
...
#)
#values (
#  'foodanalytics', null, '$2a$12$C9m5OWERVAXiq9hKQCKdAew611bdK2vVROZX5HjyI0rrV8ynw7aOW',
...
# Insert de outra versao antiga do spring security
